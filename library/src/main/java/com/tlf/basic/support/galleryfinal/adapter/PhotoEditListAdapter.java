...
package com.tlf.basic.support.galleryfinal.adapter;
...
import com.tlf.basic.support.galleryfinal.PhotoEditActivity;
import com.tlf.basic.support.galleryfinal.model.PhotoInfo;
import com.tlf.basic.support.galleryfinal.widget.GFImageView;
...
public class PhotoEditListAdapter extends ViewHolderAdapter<PhotoEditListAdapter.ViewHolder, PhotoInfo> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mIvPhoto.setImageResource(R.mipmap.ic_gf_default_photo);
