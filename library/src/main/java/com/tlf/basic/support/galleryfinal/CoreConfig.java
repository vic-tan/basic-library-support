...
public class CoreConfig {
    ...
    private GalleryFinalImageLoader imageLoader;
    ...
    public static class Builder {
        ...
        public Builder(Context context, GalleryFinalImageLoader imageLoader, ThemeConfig themeConfig) {
    ...
    public GalleryFinalImageLoader getImageLoader() {
        return imageLoader;
    }
